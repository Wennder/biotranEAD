                ...
                <div id="header">
                    <div id="topmenu">
                        ...
                        <ul>
                            ...
                            <li class="<?php echo $retorno = $_GET['a']=='cadastro' ? 'selecionado':'n_selecionado' ?>" ><div class="detalhe_left"></div><div class="menu_holder"><a href="index.php?c=index&a=cadastro">CADASTRO</a></div><div class="detalhe_right"></div></li>
                        </ul>
                    </div>
