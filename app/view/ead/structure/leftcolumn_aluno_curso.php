...
<div id="page-leftcolumn" class="leftcolumn">
    ...
    <dl>
        <dt>
        <a class="navbar_item descricaoIcon link desc" href="#" id="index.php?c=ead&a=pag_curso&id=<?php echo $id_curso ?>">Página do Curso</a>
        </dt>
        <dt class="fechado">
        ...
        <dd>
            <ul>
                <?php echo $controllerModulo->lista_visualizarModulos_lefcolumn_aluno($id_curso); ?>
            </ul>
        </dd>
        <dt>
        <?php
